    ...
    useEffect(() => {
        const fetching = async () => {
            try {
                ...
                const categories = response.data.under_spent.map((eachItem: any) => eachItem.category);
                const overSpentCategories = response.data.over_spent.map((eachItem: any) => eachItem.category);
                                ...
                                <ItemSubContainerMonthReview>
                                    <OverviewContainer>
                                        ...
                                        <ContentsAlignment>
                                            ...
                                            <MonthReviewContainerSubHeading>
                                                Keep up the great work, and remember to invest wisely to secure your financial future!
                                            </MonthReviewContainerSubHeading>
                                            <CategoryItemsMonthlyReview>
                                ...
                                <ItemSubContainerMonthReview>
                                    <OverviewContainer>
                                        ...
                                        <ContentsAlignment>
                                            ...
                                            <MonthReviewContainerSubHeading>
                                                Watch out! You’ve spent more than the suggested amount in these areas:
                                            </MonthReviewContainerSubHeading>
                                            <CategoryItemsMonthlyReview>
                                    ...
                                    <MoreContentsReview>
                                        ...
                                        <React.Fragment>
                                            ...
                                            {overSpentCategoriesArr.map((eachItem: any) => (
                                                ...
                                                <TextCategory>
    You've spent <ActualAmount>₹{Math.round(eachItem.actual_amount)}</ActualAmount> on{" "}
    <CategoryItem>{eachItem.category}</CategoryItem>, which is{" "}
    <AmountMinus>{Math.round(eachItem.actual_amount - eachItem.recommended_amount)}</AmountMinus> more than the
    suggested amount of ₹<RecommentAmount>{Math.round(eachItem.recommended_amount)}</RecommentAmount>.
</TextCategory>
