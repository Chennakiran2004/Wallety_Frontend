  ...
  return (
    <AnimatePresence mode="wait">
        ...
        <SignUpSubContainer>
            ...
            <FieldsContainer onSubmit = {(e)=> {e.preventDefault()}}>
            ...
            {error && <p>{error}</p>}
            <SignUpButton type = "submit" onClick = {submitForm}>Login</SignUpButton>
            <AlreadyHaveAnAccout>Don’t have an account yet? <LoginLink to = "/Signup">Sign Up</LoginLink></AlreadyHaveAnAccout>
            </FieldsContainer>
        </SignUpSubContainer>
        </SignUpContainer>
    </AnimatePresence>
